...
const Overview = ({ conversation, ptptCount, ptptCountTotal, math, computedStats }) => {
  return (
    <div>
      <div>
        <p style={globals.primaryHeading}>{f("narrative_report_beta")}</p>
        ...
        <p style={globals.secondaryHeading}>
          <strong>{f("narrative_report_title")}</strong>
        </p>
        <p style={globals.paragraph}>
          {f("narrative_report_beta_desc")}
        </p>
        <p style={globals.paragraph}>
          {f("narrative_report_bottleneck_desc")}
        </p>
        <p style={globals.paragraph}>
          {f("narrative_report_llm_warning")}
        </p>
        <p style={globals.secondaryHeading}>
          <strong>{f("narrative_report_generating_title")}</strong>
        </p>
        <p style={globals.paragraph}>
          {f("narrative_report_generating_desc")}
        </p>
        <p style={globals.paragraph}>
          {f("narrative_report_sharing_warning")}
        </p>
        <p style={globals.secondaryHeading}>
          <strong>{f("narrative_report_reviewing_title")}</strong>
        </p>
        <p style={globals.paragraph}>
          {f("narrative_report_reviewing_desc")}
        </p>
        <ol style={globals.paragraph}>
          <li>{f("narrative_report_reviewing_list_1")}</li>
          <li>{f("narrative_report_reviewing_list_2")}</li>
          <li>{f("narrative_report_reviewing_list_3")}</li>
          <li>{f("narrative_report_reviewing_list_4")}</li>
        </ol>
        <p style={globals.paragraph}>
          {f("narrative_report_feedback_desc")}
        </p>
      </div>
